                    ...
                    if (c instanceof JCheckBox) {
                        JCheckBox checkbox = (JCheckBox) c;
                            if (checkbox.isSelected()) {
                                JLabel label = new JLabel("<html><u><font color='blue'>" + checkbox.getText() + "</font></u></html>");
                        ...
                        // Add the selected courses to the selected courses panel
                            for (Component c : panel.getComponents()) {
                                if (c instanceof JCheckBox && ((JCheckBox) c).isSelected()) {
                                    JLabel label = new JLabel("<html><u><font color='blue'>" + ((JCheckBox) c).getText() + "</font></u></html>");
                                    label.setCursor(Cursor.getPredefinedCursor(Cursor.HAND_CURSOR));
                                    label.addMouseListener(new MouseAdapter() {
                                        @Override
                                        public void mouseClicked(MouseEvent e) {
